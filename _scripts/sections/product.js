...
const selectors = {
  form: '[data-product-detail-form]',
  gallery: '[data-product-detail-gallery]'
}
...
export default class ProductSection extends BaseSection {
  constructor(container) {
    ...
    this.productDetailForm = new ProductDetailForm($(selectors.form, this.$container).first(), {
      onVariantChange: this.onVariantChange.bind(this)
    })

    this.galleries = $.map($(selectors.gallery, this.$container), el => new ProductDetailGallery(el))
  }
